...
void encoder_encoder::encoder_param_init(int width, int height)
{
    ...
    h264_param.IDRPeriod                = 10;                       ///I帧间隔   0:all frame is P frame 1:all frame is I frame 2：IPIP 3：IPPIPPIPP
    ...
    h264_param.Bitrate                  = 128000;                   ///码率 1 ~
    ...
    h264_param.LevelIDC                 = 40;                       ///视频本身特性描述 1（level1.0）～40（level4.0）
    ...
    h264_param.FrameMap                 = NV12_LINEAR;              ///nv12线性模式 or NV12_TILE 块模式
}
